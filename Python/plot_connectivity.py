...
file_path = '../data/actual_connectivity.csv' # generated by ./MATLAB/shuffling.m
...
sns.swarmplot(data=df_0_long, x='Area', y='Connectivity', hue='Hemisphere', 
              dodge=True, 
              size=5,
              edgecolor='black',
              linewidth=1,
...
plt.ylabel("WM Connectivity")

sns.catplot(
    data=df_2_long, kind="violin",
    x='Area', y='Connectivity', hue='Hemisphere',
    inner=None,
    fill=False,
    legend=False,
...
sns.swarmplot(data=df_2_long, x='Area', y='Connectivity', hue='Hemisphere', 
              dodge=True, 
              size=5,
              edgecolor='black',
              linewidth=1,
